...
export default function Help() {
  return (
    <div className="space-y-6 pb-8">
      ...
      <Accordion type="single" collapsible className="space-y-2">
        {HELP_SECTIONS.map((section) => (
          ...
          >
            ...
            <AccordionContent className="bg-white border-2 border-t-0 border-sky-100 rounded-b-xl px-4 py-4">
              {section.content}
            </AccordionContent>
          </AccordionItem>
        ))}
      ...
      <Accordion type="single" collapsible className="space-y-0 border border-sky-100 rounded-xl overflow-hidden bg-white shadow-md">
        <AccordionItem value="about" className="border-b border-sky-100 last:border-b-0">
          <AccordionTrigger className="px-4 py-4 text-slate-800 font-medium hover:no-underline hover:bg-sky-50">
        ...
        <AccordionItem value="faqs" className="border-b border-sky-100 last:border-b-0">
          <AccordionTrigger className="px-4 py-4 text-slate-800 font-medium hover:no-underline hover:bg-sky-50">
            FAQs
          </AccordionTrigger>
            ...
            <div className="space-y-4 text-sm">
              {FAQ_ITEMS.map((item, i) => (
                <div key={i} className="text-slate-700">
                  <p className="font-semibold text-slate-800 mb-1">Q: {item.q}</p>
        ...
        <AccordionItem value="what-is-globe" className="border-b border-sky-100 last:border-b-0">
          <AccordionTrigger className="px-4 py-4 text-slate-800 font-medium hover:no-underline hover:bg-sky-50">
            What is GLOBE?
          </AccordionTrigger>
          <AccordionContent className="px-4 pb-4 text-sm text-slate-600">
        ...
        <AccordionItem value="how-to-join" className="border-b border-sky-100 last:border-b-0">
          <AccordionTrigger className="px-4 py-4 text-slate-800 font-medium hover:no-underline hover:bg-sky-50">
            How to Join GLOBE?
          </AccordionTrigger>
          <AccordionContent className="px-4 pb-4 text-sm text-slate-600">
